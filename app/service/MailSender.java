...
public class MailSender {
    ...
    public void sendTeqMail(Candidate candidate) throws MessagingException {

        String email = Play.application().configuration().getString("email.address");
     ...
     */
    private void send(final String username, final String password, String recipientEmail, String title, String message) throws MessagingException {
